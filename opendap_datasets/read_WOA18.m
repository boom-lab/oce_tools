...
% var_code:     WOA18 code for variable type (e.g. 'an')
...
%
% USAGE:
% [o2,x,y,z,t] = read_WOA18('oxygen','an','03',1);
% 
% 
% AUTHOR: David Nicholson // dnicholson@whoi.edu // 12 March 2020
% -------------------------------------------------------------------------

function [data, varargout] = read_WOA18(varname,var_code,tspec,res,varargin)
...
% root address for WOA18 server

thredds = 'https://data.nodc.noaa.gov/thredds/dodsC/ncei/woa/';


% create file name to append
fname = strcat(thredds,varname,'/all/',res_str1,'/woa18_all_',name2var(varname),tspec,'_',res_str2,'.nc');
